    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
          ...
          AuthOp.DefaultAuthenticateScheme = JwtBearerDefaults.AuthenticationScheme
           ...
           ).AddJwtBearer(JwtBearerDefaults.AuthenticationScheme, ConfOp =>
           {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "JwtFaceBook2 v1"));
            }
